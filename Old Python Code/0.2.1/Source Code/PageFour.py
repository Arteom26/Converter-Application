...
class PageFour(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.comboBox['values'] = ('Fahrenheit', 'Celsius', 'Kelvins')
        ...
        self.comboBox2['values'] = ('Fahrenheit', 'Celsius', 'Kelvins')
        self.comboBox2.current(0)

        btn1 = ttk.Button(self, text="Convert", command=self.converted)
        btn1.grid(column=7, row=2)

        btn2 = ttk.Button(self, text="Back", command=lambda: controller.show_frame(converter.StartPage))
    ...
    def converted(self):
        if self.combVar.get() == self.combVar2.get():
            ...
            label.grid(column=8, row=2)
            label2.grid(column=9, row=2)
        elif self.combVar.get() == "Kelvins" and self.combVar2.get() == "Celsius":
            total = (float(self.amt.get()) - 273.15)
            self.l.set(str(total))
            self.l2.set(" Celsius")
            label = ttk.Label(self, textvariable=self.l, font=SMALL_FONT)
            label2 = ttk.Label(self, textvariable=self.l2, font=SMALL_FONT)
            label.grid(column=8, row=2)
            label2.grid(column=9, row=2)
        elif self.combVar.get() == "Celsius" and self.combVar2.get() == "Kelvins":
            total = (float(self.amt.get()) + 273.15)
            self.l.set(str(total))
            self.l2.set(" Kelvins")
            label = ttk.Label(self, textvariable=self.l, font=SMALL_FONT)
            ...
            label.grid(column=8, row=2)
            label2.grid(column=9, row=2)
        elif self.combVar.get() == "Kelvins" and self.combVar2.get() == "Fahrenheit":
            total = (float(self.amt.get())*(9/5)) - 459.67
            self.l.set(str(total))
            self.l2.set(" Fahrenheit")
            label = ttk.Label(self, textvariable=self.l, font=SMALL_FONT)
            label2 = ttk.Label(self, textvariable=self.l2, font=SMALL_FONT)
            label.grid(column=8, row=2)
            label2.grid(column=9, row=2)
        elif self.combVar.get() == "Fahrenheit" and self.combVar2.get() == "Kelvins":
            total = (float(self.amt.get()) + 459.67)*(5/9)
            self.l.set(str(total))
            self.l2.set(" Kelvins")
            label = ttk.Label(self, textvariable=self.l, font=SMALL_FONT)
            label2 = ttk.Label(self, textvariable=self.l2, font=SMALL_FONT)
